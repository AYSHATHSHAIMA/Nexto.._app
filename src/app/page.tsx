...
export default async function Home() {
  ...
  return (
    <div className="  container-fluid flex flex-row flex-wrap flex-center justify-center font-sans  items-start  min-h-screen p-2 pb-0 gap-0 sm:p-20">
<main className="flex flex-wrap justify-center items-start gap-4 p-4">
        {/* <Image
